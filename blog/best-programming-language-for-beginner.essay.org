...
Life changes and programming is hard. So you should go with a language that's interesting to you – for whatever reason – and which is particularly suitable for learning, according to the criteria I lay out below. Read on, I will describe the most interesting languages afterwards.
