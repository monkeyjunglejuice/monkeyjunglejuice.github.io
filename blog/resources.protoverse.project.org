...
- [[https://hal.science/file/index/docid/96280/filename/processes.pdf][On Differential Interaction Nets and the Pi-Calculus]] (Thomas Erhard and Olivier Laurent) Encoding Pi-Calculus (high-level) as Interaction Nets (low-level).
