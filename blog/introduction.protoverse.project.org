...
The Protoverse is a computational experiment with the intent to build an open-ended artificial universe through an extreme bottom-up approach.

My aim is to build multi-scale computational substrates where intrinsic, open-ended evolutionary processes are the consequential outcome of systemic interactions.
...
Consider the human brain: its functioning (what makes the brain a brain and not merely a lump of "matter" and "forces") is not about physical interactions, but higher-order: biological processes, cognitive phenomena, and emergent properties arising from complex networks. The brain is constituted by Nested Scale of Complexity, resulting in a higher-order substrate where novel rules and dynamics overlay the physical laws of underlying Scales, even though it's still entirely implemented in them.

Thus, the Protoverse project has to transcend traditional disciplinary boundaries, integrating ideas from computational philosophy, evolutionary theory, process philosophy, automata theory, complex adaptive systems, chaos theory, quantum theory, and systems architecture with emphasis on concurrency and massive parallelism. This interdisciplinary approach acknowledges the richness of reality and its many scales.
...
The human experience tends to assign special status to this, privilege to that, and ultimately alway to itself in one way or the other:
